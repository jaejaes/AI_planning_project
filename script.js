...
const mobileCopy = {
  dashboard: {
    title: '상환 우선순위 안내',
    text: '기관의 AI 추천이 차주에게 어떤 부채를 먼저 상환해야 하는지 명확하게 전달되는 단계입니다.'
  },
  analysis: {
    title: '이자 부담 근거 제시',
    text: '추천 근거를 수치로 설명해 차주가 상환 순서를 납득하도록 돕는 분석 화면입니다.'
  },
  simulator: {
    title: '개인화 인센티브 체감',
    text: '금리 인하나 혜택이 월 이자 절감으로 어떻게 체감되는지 즉시 보여줍니다.'
  },
  credit: {
    title: '행동 변화의 보상 강화',
    text: '상환 이후 신용 개선과 진행도를 보여줘 우선 상환 행동이 유지되도록 만듭니다.'
  }
};
